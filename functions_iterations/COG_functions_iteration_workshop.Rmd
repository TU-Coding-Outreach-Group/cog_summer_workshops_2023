...
```{r Activity_01_01 my_square_root}
my_square_root <- function(____){
  return_value <- sqrt(____)
  return(____)
}
...
```{r Activity_01_02 my_max_minus_min}
my_max_minus_min <- ____(____){
...
```{r more than 1 argument example}
...
embed_url("https://youtu.be/hNn_a7MZJYY")
...
embed_url("https://youtu.be/xCw_Ysger0o")
...
# description: import_date takes a date and returns a data file from that date
...
embed_url("https://youtu.be/nPmE17UbYG0")
