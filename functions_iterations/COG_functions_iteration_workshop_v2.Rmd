...
author: 
  ...
  - name: "Content editor: **Katie Jobson**"
output:
  html_document:
    cold_folding: show
...
```{r Activity_01_01 my_square_root, eval=F, warning=F, class.source = 'fold-hide'}
...
Click `CODE` to see the solution! ==>
    ...
    ```{r, eval=F, warning=F, class.source = 'fold-hide'}
    # description: 
    # input: 
    # output: 
    # requires:
