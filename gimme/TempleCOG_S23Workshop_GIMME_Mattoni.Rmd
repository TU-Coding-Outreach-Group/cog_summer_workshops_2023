...
# COG Workshop Summer 2023: GIMME
...
Please download example data from [here](ENTER GITHUB LINK TO DATA) to continue with this walkthrough. This is fMRI BOLD data from 15 ROIs and 2 exogenous variables from Dr. Tom Olino's TADS study. I only included data from 20 individuals for timing purposes. 
...
data_list <- split(long_df,long$ID) #Divdes the long_df into groups based on id
filenames <- paste0("C:/Users/.../",names(data_list), ".csv") #creates vector of file names, concatenating a path, an id, and .csv
Map(write.csv,data_list,filenames) #Map applies a function (write.csv) with arguments of corresponding elements in vectors 
```
...
gimme_out <- gimmeSEM(data = 'C:/Users/mmatt/Desktop/COG-GIMME/Data',
                      sep = ",",
                      header = T,
                      out = 'C:/Users/mmatt/Desktop/COG-GIMME/Output',
                      ar = T,
                      plot = T,
                      subgroup = T,
                      standardize = T,
                      ...
                      groupcutoff = .75,
                      subcutoff = .5)
saveRDS(gimme_out,'C:/Users/mmatt/Desktop/Workshops/Hosted/GIMME/gimme_output.rds')
