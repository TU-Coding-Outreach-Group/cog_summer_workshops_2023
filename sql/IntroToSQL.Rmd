...
3. Open SQL Server to configure your connection (follow the in-program instructions) - once you have configured, click **Connect Now** to get the server name and location on your computer

![](images/sqllcmd.png)

4. Open 

2. Run the chunk of code below to load packages in R that can deal with SQL data and code

```{r, echo = FALSE}
install.packages(c("DBI", "sqldf", "odbc"))
library(DBI, sqldf, odbc)
