...
An example of something that we work with that is like SQL would be GitHub. It allows data to be stored in a centralized place. Others are able to access and add to this data. 
...
This isn't a programming language one would readily encounter in academia. Our datasets are not often big enough to justify using SQL. 
