...
```{sql class.source = 'fold-hide', error=FALSE, eval=FALSE, warning=FALSE}
...
Now, we have seen this done before, but this is your opportunity to try and apply what you have already seen in this workshop. The `COUNTRY` variable in the `AGENTS` table is blank. Figure out what country should go into each row for this dataset (hint: )
