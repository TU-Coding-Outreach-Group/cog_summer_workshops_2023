...
1. Download the ODBC Driver, to be able to initalize other code: https://learn.microsoft.com/en-us/sql/connect/odbc/download-odbc-driver-for-sql-server?view=sql-server-ver16

2. Run the chunk of code below to load packages in R that can deal with SQL data and code

```{r, echo = FALSE}
install.packages("DBI", "sqldf", "odbc")
